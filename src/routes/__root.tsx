...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Diell Morina — Front-End Developer" },
      {
        name: "description",
        content:
  ...
  return (
    <html lang="en">
      <head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-41D8GFXXLB"
        />
        <script
          dangerouslySetInnerHTML={{
            __html: `window.dataLayer = window.dataLayer || [];\nfunction gtag(){dataLayer.push(arguments);}\ngtag('js', new Date());\ngtag('config', 'G-41D8GFXXLB');`,
          }}
        />
      ...
      <body>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-TGDZBKV6"
            height="0"
            width="0"
